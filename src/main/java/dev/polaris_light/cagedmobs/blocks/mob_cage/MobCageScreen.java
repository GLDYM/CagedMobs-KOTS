...
public class MobCageScreen extends AbstractContainerScreen<MobCageContainer> {
    ...
    private final ResourceLocation GUI = ResourceLocation.fromNamespaceAndPath(CagedMobs.MODID, "textures/gui/mob_cage.png");
    private final ResourceLocation UPGRADE_SLOT_OUTLINE = ResourceLocation.fromNamespaceAndPath(CagedMobs.MODID, "textures/gui/upgrade_slot.png");
    private final ResourceLocation ENVIRONMENT_SLOT_OUTLINE = ResourceLocation.fromNamespaceAndPath(CagedMobs.MODID, "textures/gui/environment_slot.png");
