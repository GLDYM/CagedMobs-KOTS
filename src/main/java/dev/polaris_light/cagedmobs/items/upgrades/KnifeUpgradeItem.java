...
public class KnifeUpgradeItem extends UpgradeItem {
    public KnifeUpgradeItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull Item.TooltipContext context, @Nonnull List<Component> tooltipComponents, @Nonnull TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("item.cagedmobs.knife_upgrade.info").withStyle(ChatFormatting.GRAY));
