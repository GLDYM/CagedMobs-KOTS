...
public class SpeedIUpgradeItem extends UpgradeItem{
    public SpeedIUpgradeItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull Item.TooltipContext context, @Nonnull List<Component> tooltipComponents, @Nonnull TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("item.cagedmobs.speed_i_upgrade.info").withStyle(ChatFormatting.GRAY));
