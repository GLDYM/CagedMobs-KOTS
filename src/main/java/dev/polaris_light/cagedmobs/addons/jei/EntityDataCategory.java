...
public class EntityDataCategory implements IRecipeCategory<EntityDataWrapper> {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(CagedMobs.MODID, "entity");
    ...
    public EntityDataCategory(IGuiHelper gui, RecipeType<EntityDataWrapper> type){
        ...
        ResourceLocation backgroundRL = ResourceLocation.fromNamespaceAndPath(CagedMobs.MODID, "textures/gui/jei_recipe.png");
