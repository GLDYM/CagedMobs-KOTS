...
public class CagedCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CAGED_CREATIVE_TABS_REGISTER = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CagedMobs.MODID);

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB = CAGED_CREATIVE_TABS_REGISTER.register("cagedmobs_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems(((pParameters, pOutput) -> {
                ...
                pOutput.accept(CagedItems.KNIFE_UPGRADE.get());
